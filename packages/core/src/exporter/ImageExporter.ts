...
import {backendWs} from './backend-client';
...
export class ImageExporter implements Exporter {
  public static readonly id = '@reelgen/core/image-sequence';
  ...
  private static initialize() {
    ...
    backendWs.on('revideo:export-ack', (response: ServerResponse) => {
