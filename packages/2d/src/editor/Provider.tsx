...
import type {Scene2D} from '@reelgen/2d';
import {SceneRenderEvent} from '@reelgen/core';
import {useApplication, useCurrentScene} from '@reelgen/ui';
...
export const NodeInspectorKey = '@reelgen/2d/node-inspector';
