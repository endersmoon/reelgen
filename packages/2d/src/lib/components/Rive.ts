...
export class Rive extends Rect {
  ...
  @initial(0)
  @signal()
  declare public readonly artboardId: SimpleSignal<number | string, this>;

  @initial(0)
  @signal()
  declare public readonly animationId: SimpleSignal<number | string, this>;
