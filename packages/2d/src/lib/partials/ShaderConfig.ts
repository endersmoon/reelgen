import type {SignalValue, WebGLConvertible} from '@reelgen/core';
import {experimentalLog, useLogger, useScene} from '@reelgen/core';
...
export interface ShaderConfig {
   ...
   *
   * #include "@reelgen/core/shaders/common.glsl"
   *
   * void main() {
